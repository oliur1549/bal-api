...
COPY ballerina-http-2.9.0.jar /home/ballerina/jars/ 
COPY ballerina-http.httpscerr-2.9.0.jar /home/ballerina/jars/ 
...
COPY http-native-2.9.0.jar /home/ballerina/jars/ 
...
COPY hp-usersAPI-0.1.0.jar /home/ballerina/jars/ 
RUN addgroup troupe \
...
CMD java -Xdiag -cp "hp-usersAPI-0.1.0.jar:jars/*" 'hp.usersAPI.0.$_init'
